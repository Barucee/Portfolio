...
pages = st.sidebar.selectbox('Select the page', ['Introduction', 'About the models 🧭', 'Forecasting 📈'])
...
if pages == "Introduction":
    ...
    if model == "ARIMA":
        ...
        plt.plot(train_arima, color='blue', label='Test')
        plt.plot(Prediction_arima, color='red', label='Test')
